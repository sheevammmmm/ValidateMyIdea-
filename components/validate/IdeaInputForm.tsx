      ...
      <Card className="border-slate-200 bg-white">
        <CardHeader className="space-y-4">
          ...
          <div>
            ...
            <p className="mt-2 text-sm text-slate-600">Share your idea clearly. Keep it simple.</p>
          </div>
        </CardHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>No strict length requirement. Just make the idea understandable.</FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              />
